...
import org.adaptable.agent.web.Url
...
class ServerHandlerMappingTest : FunSpec() {
    ...
    init {
        ...
        test("returns null when endpoint is unavailable") {
            ...
            val serviceConfiguration = mock(ServiceConfiguration::class.java)
    ...
    companion object {
        private fun getServiceConfiguration(): ServiceConfiguration {
        ...
        private fun callHandler(request: HttpServletRequest, serviceConfiguration: ServiceConfiguration = getServiceConfiguration()) : Any? {
        ...
        private fun callProcess(serviceConfiguration: ServiceConfiguration, request: HttpServletRequest, body: Any?) : Any? {
