...
import org.adaptable.common.api.annotations.EndPointType
...
class ServiceConfigurationImpl(
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(ServiceConfigurationImpl::class.java)
    }
    ...
    init {
        ...
        for (endPointDef in serviceDefinition.endPoints!!) {
            ...
            logger.info("Constructing endpoint id: ${endPointDef.id} of type: ${endPointDef.type}")
            ...
            val endPointMeta = type.getAnnotation(org.adaptable.common.api.annotations.EndPoint::class.java)
