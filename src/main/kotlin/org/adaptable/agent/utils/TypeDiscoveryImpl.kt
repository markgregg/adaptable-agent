...
import org.adaptable.agent.configuration.InvalidClassException
...
class TypeDiscoveryImpl : TypeDiscovery {
    ...
    override fun getEndPointTypes(): Map<String,Class<*>> {
        return discoverTypeMapByAnnotation<org.adaptable.common.api.annotations.EndPoint,String,Class<*>>(org.adaptable.common.api.annotations.EndPoint::class.java) {
            (it.getAnnotationInfo(org.adaptable.common.api.annotations.EndPoint::class.java).parameterValues.getValue("value") as String).lowercase() to it.loadClass()
        }
    }

    override fun getConverterTypes(): Map<String, MessageConverter> {
        return discoverTypeMapByAnnotation(org.adaptable.common.api.annotations.Converter::class.java) {
            ...
            (it.getAnnotationInfo(org.adaptable.common.api.annotations.Converter::class.java).parameterValues.getValue("value") as String).lowercase() to
